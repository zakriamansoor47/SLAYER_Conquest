...
public partial class SLAYER_Conquest : BasePlugin, IPluginConfig<SLAYER_ConquestConfig>
{
    ...
    [ConsoleCommand("settings", "Open the Conquest settings menu")]
    ...
    [ConsoleCommand("startmatch", "Start the match immediately")]
    [RequiresPermissions("@css/root")] // Only admins can use this command
    ...
    [ConsoleCommand("endmatch", "End the match immediately")]
    [RequiresPermissions("@css/root")] // Only admins can use this command
    ...
    [ConsoleCommand("givepoints", "Give points to a player")]
    [RequiresPermissions("@css/root")] // Only admins can use this command
    ...
    [ConsoleCommand("takepoints", "Take points from a player")]
    [RequiresPermissions("@css/root")] // Only admins can use this command
