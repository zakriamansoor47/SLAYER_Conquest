...
public class SLAYER_ConquestConfig : BasePluginConfig
{
    ...
    public Dictionary<string, ClassAttributeConfig> ClassAttributes { get; set; } = new Dictionary<string, ClassAttributeConfig>
    {
        ["Assault"] = new ClassAttributeConfig
        {
            ...
            HasHelmet = true,
            Speed = 1.0f,
            T_Model = "agents/models/tm_jungle_raider/tm_jungle_raider_variantb.vmdl",
            CT_Model = "agents/models/ctm_st6/ctm_st6_varianti.vmdl",
        ...
        ["Engineer"] = new ClassAttributeConfig
        {
            ...
            HasHelmet = true,
            Speed = 0.9f,
            T_Model = "agents/models/tm_jungle_raider/tm_jungle_raider_variantd.vmdl",
            CT_Model = "agents/models/ctm_swat/ctm_swat_varianti.vmdl",
        ...
        ["Medic"] = new ClassAttributeConfig
        {
            ...
            HasHelmet = true,
            Speed = 1.1f,
            T_Model = "agents/models/tm_leet/tm_leet_varianth.vmdl",
            CT_Model = "agents/models/ctm_swat/ctm_swat_variantg.vmdl",
        ...
        ["Recon"] = new ClassAttributeConfig
        {
            ...
            HasHelmet = false,
            Speed = 0.95f,
            T_Model = "agents/models/tm_leet/tm_leet_variantj.vmdl",
            CT_Model = "agents/models/ctm_st6/ctm_st6_variante.vmdl",
    ...
    [JsonPropertyName("VictoryAnimations")] public List<string> VictoryAnimations { get; set; } = new List<string>
    {
        ...
        "celebrate_mask_start",
        "celebrate_mask_idle01",
        "celebrate_mask_idle02",
        "celebrate_mask_idle03",
        "celebrate_mask_idle04",
        "celebrate_mask_idle05",
        "celebrate_mask_idle06",
        "end_match_noweap01_start",
        "end_match_noweap01_idle01",
        "end_match_noweap01_idle02",
        "end_match_noweap03_start",
        "end_match_noweap03_idle01",
        "end_match_noweap03_idle02",
        "end_match_noweap03_idle03"
    };
